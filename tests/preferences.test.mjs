...
test('preferences default to alto sax and four measures per row', () => {
...
test('preferences restore valid saved values and reject stale values', () => {
  assert.deepEqual(loadPreferences(memoryStorage({
  ...
  })), { instrumentId: 'saxophone', measuresPerRow: 4 });
});
...
test('restricted storage falls back safely and write failures stay non-fatal', () => {
  ...
  assert.deepEqual(loadPreferences(storage), { instrumentId: 'saxophone', measuresPerRow: 4 });
